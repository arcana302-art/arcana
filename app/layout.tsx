...
(function(){
  ...
  if (document.readyState === 'loading'){
    ...
    init();
        ...
        {/* ===== SCRIPT: Ajuste de ESTRELLAS (conserva ~25%, 10 featured con dim; resto no desaparecen) ===== */}
...
(function(){
  ...
  function adjustStars(){
    ...
    // 1) Conservar ~25% (>> mitad menos). Siempre al menos 10.
    shuffle(stars);
    var keep = Math.max(10, Math.ceil(stars.length * 0.25));
